...
#
# Created: Fri Apr 21 10:52:37 2017
...
class Ui_PPC_checkDialogBase(object):
    def setupUi(self, PPC_checkDialogBase):
        ...
        self.useSelectedAPPC_2 = QtGui.QCheckBox(self.groupBox_7)
        self.useSelectedAPPC_2.setGeometry(QtCore.QRect(30, 60, 181, 17))
        self.useSelectedAPPC_2.setObjectName(_fromUtf8("useSelectedAPPC_2"))
        self.radioButtonDB_ob = QtGui.QRadioButton(self.groupBox_7)
        self.radioButtonDB_ob.setGeometry(QtCore.QRect(230, 60, 61, 17))
        ...
        self.radioButtonDB_Nadir.setGeometry(QtCore.QRect(300, 60, 82, 17))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(30, 120, 371, 91))
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.checkBoxSize = QtGui.QCheckBox(self.groupBox_5)
        self.checkBoxSize.setGeometry(QtCore.QRect(20, 50, 111, 17))
        self.checkBoxSize.setObjectName(_fromUtf8("checkBoxSize"))
        self.checkBoxNaming = QtGui.QCheckBox(self.groupBox_5)
        self.checkBoxNaming.setGeometry(QtCore.QRect(20, 20, 231, 17))
        self.checkBoxNaming.setObjectName(_fromUtf8("checkBoxNaming"))
        self.radioButton8000 = QtGui.QRadioButton(self.groupBox_5)
        self.radioButton8000.setGeometry(QtCore.QRect(80, 50, 81, 17))
        self.radioButton8000.setObjectName(_fromUtf8("radioButton8000"))
        self.radioButton5000 = QtGui.QRadioButton(self.groupBox_5)
        self.radioButton5000.setGeometry(QtCore.QRect(170, 50, 82, 17))
        self.radioButton5000.setObjectName(_fromUtf8("radioButton5000"))
        self.groupBox_4 = QtGui.QGroupBox(self.tab_Disk)
        self.groupBox_4.setGeometry(QtCore.QRect(30, 10, 371, 91))
        self.groupBox_4.setObjectName(_fromUtf8("groupBox_4"))
        self.radioButtonImage_ob = QtGui.QRadioButton(self.groupBox_4)
        self.radioButtonImage_ob.setGeometry(QtCore.QRect(210, 60, 61, 17))
        self.radioButtonImage_ob.setObjectName(_fromUtf8("radioButtonImage_ob"))
        self.radioButtonImage_Nadir = QtGui.QRadioButton(self.groupBox_4)
        self.radioButtonImage_Nadir.setGeometry(QtCore.QRect(280, 60, 71, 17))
        self.radioButtonImage_Nadir.setObjectName(_fromUtf8("radioButtonImage_Nadir"))
        self.lineEditImageDir = QtGui.QLineEdit(self.groupBox_4)
        self.lineEditImageDir.setGeometry(QtCore.QRect(20, 20, 301, 21))
        self.lineEditImageDir.setObjectName(_fromUtf8("lineEditImageDir"))
        self.pushButton_InputImage = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_InputImage.setGeometry(QtCore.QRect(330, 20, 31, 21))
        self.pushButton_InputImage.setObjectName(_fromUtf8("pushButton_InputImage"))
        ...
        self.useSelectedAImage = QtGui.QCheckBox(self.groupBox_3)
        self.useSelectedAImage.setGeometry(QtCore.QRect(30, 60, 181, 17))
        self.useSelectedAImage.setObjectName(_fromUtf8("useSelectedAImage"))
    ...
    def retranslateUi(self, PPC_checkDialogBase):
        ...
        self.useSelectedAPPC_2.setText(_translate("PPC_checkDialogBase", "Use only selected features", None))
        self.radioButtonDB_ob.setText(_translate("PPC_checkDialogBase", "Oblique", None))
        self.radioButtonDB_Nadir.setText(_translate("PPC_checkDialogBase", "Nadir", None))
        ...
        self.checkBoxSize.setText(_translate("PPC_checkDialogBase", "Size", None))
        self.checkBoxNaming.setText(_translate("PPC_checkDialogBase", "Check image naming and format", None))
        self.radioButton8000.setText(_translate("PPC_checkDialogBase", "8000x8000", None))
        self.radioButton5000.setText(_translate("PPC_checkDialogBase", "5000x5000", None))
        self.groupBox_4.setTitle(_translate("PPC_checkDialogBase", "Path to image dir:", None))
        self.radioButtonImage_ob.setText(_translate("PPC_checkDialogBase", "Oblique", None))
        self.radioButtonImage_Nadir.setText(_translate("PPC_checkDialogBase", "Nadir", None))
        self.pushButton_InputImage.setText(_translate("PPC_checkDialogBase", "...", None))
        ...
        self.groupBox_3.setTitle(_translate("PPC_checkDialogBase", "PPC or footprint file", None))
        self.useSelectedAImage.setText(_translate("PPC_checkDialogBase", "Use only selected features", None))
